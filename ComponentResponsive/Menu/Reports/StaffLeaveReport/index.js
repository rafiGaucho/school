...
export default class StaffLeaveReport extends React.Component {
      ...
      <View style={{flex:1,}}>
        ...
        <View style={{flex:1.5,backgroundColor:'#3B3B98',flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
          <View style={{flexDirection:'row',alignItems:'center'}}>
            ...
            <Text style={{color:'white',fontSize:20,fontWeight:'600',paddingTop:7}}>STAFF LEAVE REPORT </Text>
          </View>
          <View>
