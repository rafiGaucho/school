...
constructor(props) {
  ...
  render() {
    ...
    return (
      <Card style={{height:'60%',width:'85%',position:'absolute',
       ...
       <View style={{flexDirection:'row',flex:1,
          ...
          <CheckBox   checkBoxColor='blue'
            ...
            isChecked={this.state.checkedDept} leftTextStyle={[{padding:1},this.state.checkedDept?{color:'white'}:{color:'black'}]}
          ...
          <CheckBox checkBoxColor='blue'
            ...
            this.state.checkedStud?{backgroundColor:'#45aaf2'}:null]} isChecked={this.state.checkedStud}
              leftText='Students'  leftTextStyle={[{padding:10},this.state.checkedStud?{color:'white'}:{color:'black'}]} onClick={this.handleClickStud}/>
          <CheckBox checkBoxColor='blue'
            style={[{flex:1,alignItems:'center', justifyContent:'center'},
            this.state.checkedBus?{backgroundColor:'#45aaf2'}:null]} isChecked={this.state.checkedBus}
                leftText='Bus'  leftTextStyle={[{padding:20},this.state.checkedBus?{color:'white'}:{color:'black'}]} onClick={this.handleClickBus}/>
        </View>
       <View style={{flex:4}}>
         {/* {list.map((x,index)=>
